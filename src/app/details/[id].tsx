...
import { useTransactionRepository } from "@/database/useTransactiosRepository";
...
export default function Details() {
  ...
  const useTransactios = useTransactionRepository();

  function fetchDetails() {
    try {
      if (goalId) {
        const goal = useGoal.showDetails(goalId);
        const transactions = useTransactios.findByGoal(goalId);
  ...
  async function handleNewTransaction() {
    try {
      ...
      useTransactios.create({ goalId, amount: amountAsNumber });
